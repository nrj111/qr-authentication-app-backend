...
//     // Check if qrCode is not found or disabled
//     if (!qrCode) {
...
//     const authToken = jwt.sign({ userId: user._id }, process.env.TOKEN_KEY, {
//       expiresIn: "2h",
//     });

//     // Return a response as needed
//     return res.status(200).json({ success: true, message: "QR code scanned and validated successfully", authToken });
//   } catch (error) {
//     console.error(error);
...
//     console.log("Printing decoded data ", decoded);
